...
public partial class LogEntry : ObservableObject
{
    ...
    public IBrush KindBadgeBg => Kind switch
    {
        ...
        EventKind.Purchase or EventKind.Fine or EventKind.TransferOut or EventKind.Maintenance => new SolidColorBrush(Color.Parse("#381317")),
    ...
    public IBrush KindBadgeFg => Kind switch
    {
        ...
        EventKind.Purchase or EventKind.Fine or EventKind.TransferOut or EventKind.Maintenance => new SolidColorBrush(Color.Parse("#FB923C")),
