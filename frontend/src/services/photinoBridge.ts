...
export interface SettingsDto {
  ...
  auroraPath?: string;
  auroraCustomPath?: string;
  auroraIntegrationEnabled: boolean;
  auroraVolume: number;
  auroraShipGreetings?: boolean;
  auroraBlueprints?: boolean;
  auroraSafetyZones?: boolean;
  auroraRestrictedZones?: boolean;
  auroraMonitoredSpace?: boolean;
  auroraJurisdictions?: boolean;
