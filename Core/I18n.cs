...
public sealed class I18n : INotifyPropertyChanged
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Translations = new(StringComparer.OrdinalIgnoreCase)
    {
        ["de"] = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            // Finanzen & Sci-Fi Diagramme
            ["Finance_Kpi_Income"] = "▼  EINNAHMEN",
            ["Finance_Kpi_Spend"] = "▲  AUSGABEN",
            ["Finance_Kpi_Net"] = "◆  NETTO-PROFIT",
            ["Finance_Kpi_Wallet"] = "💳  MOBIGLAS WALLET",
            ["Finance_Kpi_TradeVolume"] = "📦  FRACHT-VOLUMEN",
            ["Finance_Chart_Title"] = "FINANZ-TIMELINE & CASHFLOW",
            ["Finance_Chart_Subtitle"] = "Interaktive Vektor-Zeitreihe aus Log-Events und mobiGlas-Buchungen.",
            ["Finance_Mode_Cumulative"] = "📈 Kumuliert",
            ["Finance_Mode_NetTrend"] = "📊 Netto-Trend",
            ["Finance_Mode_Cashflow"] = "📶 Cashflow-Balken",
            ["Finance_Legend_Earned"] = "Einnahmen (Earned)",
            ["Finance_Legend_Spent"] = "Ausgaben (Spent)",
            ["Finance_Legend_Net"] = "Netto-Bilanz",
            ["Finance_Filter_All"] = "Alle Buchungen",
            ["Finance_Filter_Trade"] = "Nur Fracht",
            ["Finance_Filter_Missions"] = "Nur Belohnungen",
            ["Finance_Scope_All"] = "★ Alle Sessions (Gesamt)",
            ["Finance_Scope_Current"] = "Aktuelle Session",
            ["Finance_Section_Sources"] = "EINNAHMEN NACH QUELLE",
            ["Finance_Section_Expenses"] = "AUSGABEN NACH ART",
            ["Finance_Section_Commodities"] = "WARENHANDEL & MARGEN-RANKING (Ø PREIS/SCU)",
            ["Finance_Section_Ledger"] = "LETZTE TRANSAKTIONEN & LEDGER",
            ["Finance_Empty_Chart"] = "KEINE FINANZDATEN IM AUSGEWÄHLTEN ZEITRAUM",
        ...
        ["en"] = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            // Finances & Sci-Fi Charts
            ["Finance_Kpi_Income"] = "▼  INCOME",
            ["Finance_Kpi_Spend"] = "▲  EXPENSES",
            ["Finance_Kpi_Net"] = "◆  NET PROFIT",
            ["Finance_Kpi_Wallet"] = "💳  MOBIGLAS WALLET",
            ["Finance_Kpi_TradeVolume"] = "📦  CARGO VOLUME",
            ["Finance_Chart_Title"] = "FINANCE TIMELINE & CASHFLOW",
            ["Finance_Chart_Subtitle"] = "Interactive vector time series from Star Citizen log events and mobiGlas entries.",
            ["Finance_Mode_Cumulative"] = "📈 Cumulative",
            ["Finance_Mode_NetTrend"] = "📊 Net Trend",
            ["Finance_Mode_Cashflow"] = "📶 Cashflow Bars",
            ["Finance_Legend_Earned"] = "Earned",
            ["Finance_Legend_Spent"] = "Spent",
            ["Finance_Legend_Net"] = "Net Balance",
            ["Finance_Filter_All"] = "All Transactions",
            ["Finance_Filter_Trade"] = "Cargo Only",
            ["Finance_Filter_Missions"] = "Rewards Only",
            ["Finance_Scope_All"] = "★ All Sessions (Total)",
            ["Finance_Scope_Current"] = "Current Session",
            ["Finance_Section_Sources"] = "INCOME BY SOURCE",
            ["Finance_Section_Expenses"] = "EXPENSES BY TYPE",
            ["Finance_Section_Commodities"] = "COMMODITY TRADE & MARGIN RANKING (AVG PRICE/SCU)",
            ["Finance_Section_Ledger"] = "RECENT TRANSACTIONS & LEDGER",
            ["Finance_Empty_Chart"] = "NO FINANCIAL TRANSACTIONS IN SELECTED PERIOD",
