...
public static class FleetCatalog
{
    ...
    private static readonly Dictionary<string, ShipCatalogEntry> Catalog = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Hull B"] = new("Hull B · MISC", "MISC", "MISC", "#A78BFA", "Mittlerer Frachter (384 SCU)", 7_541_100, 140, "LTI (Lifetime)"),
        ["Hull_B"] = new("Hull B · MISC", "MISC", "MISC", "#A78BFA", "Mittlerer Frachter (384 SCU)", 7_541_100, 140, "LTI (Lifetime)"),
        ["MISC Hull B"] = new("Hull B · MISC", "MISC", "MISC", "#A78BFA", "Mittlerer Frachter (384 SCU)", 7_541_100, 140, "LTI (Lifetime)"),
        ["MISC_Hull_B"] = new("Hull B · MISC", "MISC", "MISC", "#A78BFA", "Mittlerer Frachter (384 SCU)", 7_541_100, 140, "LTI (Lifetime)"),
        ...
        ["Argo RAFT"] = new("RAFT · Argo", "Argo Astronautics", "ARGO", "#F59E0B", "Frachtlader (96 SCU)", 3_366_563, 125, "LTI (Lifetime)"),
        ["ARGO RAFT"] = new("RAFT · Argo", "Argo Astronautics", "ARGO", "#F59E0B", "Frachtlader (96 SCU)", 3_366_563, 125, "LTI (Lifetime)"),
        ["ARGO_RAFT"] = new("RAFT · Argo", "Argo Astronautics", "ARGO", "#F59E0B", "Frachtlader (96 SCU)", 3_366_563, 125, "LTI (Lifetime)"),
        ["RAFT"] = new("RAFT · Argo", "Argo Astronautics", "ARGO", "#F59E0B", "Frachtlader (96 SCU)", 3_366_563, 125, "LTI (Lifetime)"),
